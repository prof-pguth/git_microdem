...
begin
   ...
   if CheckBox3.Checked or CheckBox4.Checked then begin
      GetSecondaryDatum;
      BaseMap.MapDraw.SecMapProj := tMapProjection.Create('TCVSExportForm.BitBtn1Click');
      BaseMap.MapDraw.SecMapProj.DefineDatumFromUTMZone(MDdef.PreferSecondaryDatum,BaseMap.MapDraw.SecMapProj.projUTMZone,MDDef.DefaultLatHemi,'TCVSExportForm.BitBtn1Click');
   end;
   ...
   Results.Free;
   if CheckBox3.Checked or CheckBox4.Checked then begin
      BaseMap.MapDraw.SecMapProj.Destroy;
      BaseMap.MapDraw.SecMapProj := Nil;
   end;
