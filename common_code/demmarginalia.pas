...
begin
   Legend_Placement.LegendOptions('Elevation legend',MDDef.LegendFont,MDDef.GridLegendLocation);
   CheckBox1.Checked := MDDef.GridLegendLocation.DrawItem;
...
begin
   Legend_Placement.LegendOptions('Scale bar',MDDef.LegendFont,MDDef.ScaleBarLocation,false);
   CheckBox2.Checked := MDDef.ScaleBarLocation.DrawItem;
   MapOwner.MapDraw.DeleteSingleMapLayer(MapOwner.MapDraw.LegendOverlayfName);
   MapOwner.DoFastMapRedraw;
   DrawPreview;
...
begin
   Legend_Placement.LegendOptions('Terrain category legend',MDDef.LegendFont,MDDef.TerrainCatLegend);
   CheckBox3.Checked := MDDef.TerrainCatLegend.DrawItem;
end;
...
begin
   Legend_Placement.LegendOptions('North arrow',MDDef.LegendFont,MDDef.NorthArrowLocation);
   CheckBox5.Checked := MDDef.NorthArrowLocation.DrawItem;
end;
...
begin
   Legend_Placement.LegendOptions('Map name',MDDef.TitleLabelFont,MDDef.MapNameLocation,false);
