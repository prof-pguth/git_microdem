...
begin
   ...
   if (MapForm.MapDraw.SecMapProj = Nil) then MapForm.MapDraw.SecMapProj := tMapProjection.Create('Secondary projection in TPickGrid.RedrawGrid;');
   MapForm.MapDraw.SecMapProj.DefineDatumFromUTMZone(MapForm.MapDraw.SecMapProj.h_DatumCode,MapForm.MapDraw.SecMapProj.projUTMZone,MapForm.MapDraw.SecMapProj.LatHemi,'TPickGrid.RedrawGrid');
   RedrawGrid;
end;
