...
var
   ...
   i         : integer;
begin
   if GISdb[db].MyData.IsStringOrIntegerField(GISdb[db].MyData.GetFieldName(WantedField)) then begin
   ...
   //with GISDataBase.MyData do begin
      for i := 0 to pred(GISdb[db].MyData.FieldCount) do begin
         if (GISdb[db].MyData.GetFieldName(i) = ComboBox1.Text) then begin
            ...
            BitBtn5.Enabled := GISdb[db].MyData.IsStringOrIntegerField(WantedFieldName);
            BitBtn7.Enabled := GISdb[db].MyData.IsStringOrIntegerField(WantedFieldName);
            Edit1.Enabled := GISdb[db].MyData.IsNumericField(WantedFieldName);
...
begin
   ...
   else if GISdb[db].MyData.IsStringOrIntegerField(GISdb[db].MyData.GetFieldName(WantedField)) then begin
      GISdb[db].EmpSource.Enabled := false;
