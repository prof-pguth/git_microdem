               ...
               begin
                  for i := 0 to NumPoints do begin
                     ...
                     if LatLong then begin
                        ...
                        DEMGLB[aNewMapDraw.DEMonMap].LatLongDegreeToDEMGrid(Lat,Long,xg,yg);
                        xgrids[i] := xg;
                        ygrids[i] := yg;
                     end;
                  end;
      ...
      begin {procedure RadialStraightRoute}
         ...
         for i := 0 to NumPoints do begin
            ...
            if LatLong then begin
               ...
               DEMGLB[aNewMapDraw.DEMonMap].LatLongDegreeToDEMGrid(Lat4,Long4,xg,yg);
               xgrids[i] := xg;
               ygrids[i] := yg;
            end;
            Dists[i] := i * dDistance;
...
var
   ...
   HorizDist,Distance,
   FanGX,FanGY,LeftLimit,RightLimit,XGrid,YGrid,
    ...
    {$EndIf}
      ...
      {$IfDef VCL}
         ...
         begin
            ...
            YStart := FanY - FanSize;
            YEnd := FanY + FanSize;
            DEMGlb[aNewMapDraw.DEMonMap].ClipDEMGridInteger(XStart,Ystart);
            DEMGlb[aNewMapDraw.DEMonMap].ClipDEMGridInteger(XEnd,YEnd);
