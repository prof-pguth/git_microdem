   ...
   tMyData = class
      ...
      public
       ...
       destructor Destroy;
        ...
        function UniqueEntriesInDB(FieldName : ANSIString) : tStringList;
...
function tMyData.UniqueEntriesInDB(FieldName : ANSIString) : tStringList;
begin
...
var
   sl : tStringList;
begin
   sl := UniqueEntriesInDB(FieldName);
   Result := sl.count;
   sl.Free;
end;
