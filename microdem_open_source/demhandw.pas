...
procedure TDemHandForm.GDALcompositedatumshift1Click(Sender: TObject);
begin
   MultipleGDALcompositedatumshift;
end;
...
begin
   GDAL_warp_reproject(gdaltoGeoWGS84);
end;
...
begin
   GDAL_warp_reproject(gdaltoUTMNAD83);
end;


procedure TDemHandForm.GDALwarpGeotiffviaEPSG1Click(Sender: TObject);
begin
   GDALreprojectimagetoUTMNAD831Click(Sender);
end;
...
begin
   LasToLasTools(lasAssignProjection);
end;
