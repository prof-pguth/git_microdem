...
uses
  SysUtils, Classes, xmldom, xif.StreamHelper;
...
uses
  Math, RTLConsts, Contnrs, StrUtils, XSBuiltIns, xif.Consts, xif.JPEGUtils; //XSBuiltIns for DateTimeToXMLTime
